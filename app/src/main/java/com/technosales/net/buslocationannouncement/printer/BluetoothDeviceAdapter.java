...
public class BluetoothDeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ((TicketAndTracking) mContext).configObj = new BluetoothEdrConfigBean(bluetoothDevice);
            ((TicketAndTracking) mContext).connectBlueTh();
            try {
                ((TicketAndTracking) mContext).bluetoothDeviceChooseDialog.dismiss();
